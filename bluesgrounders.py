...
st.set_page_config(
    page_title="Bristol Blues Ground Ball Analytics Dashboard",
    layout="wide",
    initial_sidebar_state="expanded",
    page_icon=":baseball:")
st.title("Bristol Blues Ground Ball Analytics")
alt.themes.enable("dark")
col= st.columns([5, 2])  # Divide the space into three equal columns

#Read in Data
df=pd.read_csv(r'C:\Users\Matt Tierney\OneDrive\2024 Bristol Blues\Ground Balls\Blues Ground Ball CSV.csv')

#Subset Game Column
game_column = df['Game'].tolist()
gamelist=df['Game'].unique()

#Subset Pitcher Columnstreamlit run C:\Users\Matt Tierney\OneDrive\2024 Bristol Blues\Ground Balls\bluesgrounders.py
